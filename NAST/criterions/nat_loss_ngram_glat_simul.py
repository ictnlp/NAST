...
@register_criterion("nat_loss_ngram_glat_simul", dataclass=LabelSmoothedDualImitationCriterionConfig)
class LabelSmoothedDualImitationCriterion(FairseqCriterion):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        loss = sum(l["loss"] * l["factor"] for l in losses)
